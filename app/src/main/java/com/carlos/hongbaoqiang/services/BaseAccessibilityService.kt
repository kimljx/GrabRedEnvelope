...
import com.carlos.hongbaoqiang.MyApplication
import com.carlos.hongbaoqiang.R
import com.carlos.hongbaoqiang.activity.MainActivity
import com.carlos.hongbaoqiang.util.ControlUse
...
abstract class BaseAccessibilityService : CBaseAccessibilityService() {
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        builder.setContentIntent(PendingIntent.getActivity(this, 0, notificationIntent, 0))
            ...
            .setSmallIcon(R.mipmap.dxb) // set the small icon in state.
