package com.carlos.hongbaoqiang.services
...
import com.carlos.hongbaoqiang.data.RedEnvelopePreferences
import com.carlos.hongbaoqiang.db.WechatRedEnvelope
import com.carlos.hongbaoqiang.db.WechatRedEnvelopeDb
import com.carlos.hongbaoqiang.util.WechatConstants
import com.carlos.hongbaoqiang.util.WechatConstants.RED_ENVELOPE_BEEN_GRAB_ID
import com.carlos.hongbaoqiang.util.WechatConstants.RED_ENVELOPE_CLOSE_ID
import com.carlos.hongbaoqiang.util.WechatConstants.RED_ENVELOPE_COUNT_ID
import com.carlos.hongbaoqiang.util.WechatConstants.RED_ENVELOPE_FLAG_ID
import com.carlos.hongbaoqiang.util.WechatConstants.RED_ENVELOPE_ID
import com.carlos.hongbaoqiang.util.WechatConstants.RED_ENVELOPE_OPEN_ID
import com.carlos.hongbaoqiang.util.WechatConstants.RED_ENVELOPE_RECT_TITLE_ID
import com.carlos.hongbaoqiang.util.WechatConstants.RED_ENVELOPE_TITLE
import com.carlos.hongbaoqiang.util.WechatConstants.RED_ENVELOPE_TITLE_ID
import com.carlos.hongbaoqiang.util.WechatConstants.WECHAT_LUCKYMONEYDETAILUI_ACTIVITY
import com.carlos.hongbaoqiang.util.WechatConstants.WECHAT_LUCKYMONEY_ACTIVITY
import com.carlos.hongbaoqiang.util.WechatConstants.WECHAT_PACKAGE
...
//        if(WechatFilter.isNotifacationFilter(event.text?.toString())) return
    ...
    private fun grabRedEnvelope() {
        /* 发现红包点击进入领取红包页面 */
        val ifGrabSelf = RedEnvelopePreferences.wechatControl.
        ifGrabSelf
    ...
    private fun openRedEnvelopeAuto(event: AccessibilityEvent) {
        ...
        GlobalScope.launch {
            ...
            val envelopes = getNodeInfosByViewId(RED_ENVELOPE_OPEN_ID,80, 5)
            ...
            val delayTime = 80L + 1000L * RedEnvelopePreferences.wechatControl.delayOpenTime
    ...
    private fun openRedEnvelopeCustom() {
        ...
        gesturePath(path,  delayTime, interval = 80, times = 3)
        status = HAS_OPENED
        LogUtils.d("opened a redenvelope")
    }
